...
-- operador_schema.clients definition
CREATE TABLE operador_schema.clients (
	id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
-- DROP TABLE operador_schema.leans;
CREATE TABLE operador_schema.leans (
	id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
-- operador_schema.leans foreign keys
ALTER TABLE operador_schema.leans ADD CONSTRAINT fkdrh3balm078ondto47lxuci2a FOREIGN KEY (client_id) REFERENCES operador_schema.clients(id);
...
-- INSERT DATA
INSERT INTO operador_schema.clients
...
INSERT INTO operador_schema.leans
(devolution, devolution_at, libro_id, prestamo_at, client_id)
